...
class LakeShore350_ControlClient(AbstractLoopThreadClient):
    ...
    def act_on_command(self, command):
        ...
        if "setHeaterOut" in command:
            setHeater_Range(command["setHeaterOut"])
    ...
    def setTemp_K(self, tempdict: dict):
        ...
        if tempdict["isSweep"]:
            ...
            self._logger.debug(
                ...
                self.Ramp_status_internal,
                self.Ramp_Rate_value,
            )
    ...
    def run_Hardware(self):
        ...
        try:
            ...
            with getInfodata.lock:
                ...
                rampstatus = getInfodata.LakeShore350.ControlSetpointRampParameterQuery(
                    output=1
                )
